 ...
 */
@WebServlet(name = "CadastrarTopo", urlPatterns = {"/CadastrarTopo"})
public class CadastrarTopo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            dao = new FilaDAO();
            boolean cond1 = dao.falsificarTudo();
            dao = new FilaDAO();
            boolean cond2 = dao.cadastrarTopo(nome, type);
